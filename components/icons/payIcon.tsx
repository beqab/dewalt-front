...
export default function PayIcon({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M22.302 10.9201V16.0701C22.302 19.1501 20.542 20.4701 17.902 20.4701H9.11203C8.37203 20.4701 7.70204 20.3701 7.12204 20.1501C5.93204 19.7101 5.12203 18.8001 4.83203 17.3401C5.23203 17.4301 5.66203 17.4701 6.11203 17.4701H14.902C17.542 17.4701 19.302 16.1501 19.302 13.0701V7.9201C19.302 7.4501 19.262 7.03014 19.182 6.64014C21.082 7.04014 22.302 8.38011 22.302 10.9201Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
